    ...
    <div class="card h-100">
      <div class="card-body">
        <div class="gutters container col-md-6">
          <div>
            <h6 style="color:#1f4037!important; font-size:23px " style="text-align:center" class="mb-2 text-primary container">Adres Güncelleme</h6>
          </div>
          <div>
            <div class="form-group">
              <label for="adres">Adres*</label>
              <input value="<?= $firstRow['address'] ?>" type="text" class="form-control" id="adres">
              <label for="x">X*</label>
              <input value="<?= $firstRow['X'] ?>"  type="text" class="form-control" id="x">
              <label for="y">Y*</label>
              <input value="<?= $firstRow['Y'] ?>"  type="text" class="form-control" id="y">
            </div>
          </div>
        </div>
      </div>
