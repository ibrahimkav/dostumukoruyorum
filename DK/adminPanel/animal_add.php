<?php 
    ...
    if (!empty($errors)) { 
        ...
        $data = [
          ...
          $statement = $db->prepare('INSERT INTO `animals` (`petname`, `animalDescription`, `breed`, `gender`, `dateOfBirth`, `vaccine1`, `date1`, `vaccine2`, `date2`, `vaccine3`, `date3`, `vaccine4`, `date4`, `isActive`, `createdDate`) VALUES (:petname, :animalDescription, :breed, :gender, :dateOfBirth, :vaccine1, :date1, :vaccine2, :date2, :vaccine3, :date3, :vaccine4, :date4, :isActive, NOW())');
        ...
        $logs_data = [
            'admin_id' => $admin_id,
            'logs' => $petname.' adlı hayvan sisteme kaydedildi.'
        ];
        ...
        $logs_statement-> execute($logs_data);
          ...
          $form_data['posted'] = 'Hayvan eklendi.';
