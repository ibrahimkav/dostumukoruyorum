  ...
  <div class="col-lg-30">
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mb-3">
          <div class="col-md-3">
            <button class="btn btn-primary" onclick="openCategoryModal()">Yeni News Ekle</button>
          </div>
        </div>
        <table class="table">
          <thead>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          ...
          <h2 class="yazi">News Düzenle</h2>
    <div class="mb-3 mt-3">
      <label for="categoryName">News Adı:</label><br>
      <input type="text" class="form-control" style="margin-top: 3px;" id="head" placeholder="News ismi giriniz." name="head" value="<?php echo $head; ?>">
    </div>
    <div class="mb-3">
      <label for="desc">News Açıklaması:</label>
      <textarea type="text" class="form-control" style="margin-top: 3px;" id="desc" placeholder="News Açıklaması" name="desc"><?php echo $desc; ?></textarea>
    </div>
    <div class="mb-3">
      <label for="content">News İçerik:</label>
      <textarea type="text" class="form-control" style="margin-top: 3px;" id="content" placeholder="News İçerik" name="content"><?php echo $content; ?></textarea>
    </div>
    <div class="mb-3">
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          ...
          <h2 class="card-title">News Ekle</h2>
          <form id="categoryForm">
            <div class="form-group">
              <label for="head">News Adı:</label>
              <input type="text" class="form-control" id="head1" placeholder="News ismi giriniz." name="head">
            </div>
            <div class="form-group">
              <label for="desc">News Açıklaması:</label>
              <textarea class="form-control" id="desc1" placeholder="News Açıklaması" name="desc"></textarea>
            </div>
            <div class="form-group">
              <label for="content">News İçerik:</label>
              <textarea class="form-control" id="content1" placeholder="News İçerik" name="content"></textarea>
            </div>
            <div class="form-group">
...
var editId  = 0;
   ...
   function openCategoryModalEdit(id) {
    ...
    $.post('/adminPanel/getNewsValuesById.php?id=' + editId, null).done(function(response) {
  ...
  $(document).on('click', '#edit', function(e) {
    ...
    Swal.fire({
      title: "Emin misiniz?", 
      text: "News düzenlemek istediğinize emin misiniz?", 
      icon: "warning",
    ...
    .then((result) => {
      if (result.value) {
        ...
        $.ajax({
          url: '/adminPanel/news_update.php',
          type: 'POST',
  ...
  $(document).on('click', '#submit', function(e) {
    ...
    Swal.fire({
      title: "Emin misiniz?", 
      text: "News eklemek istediğinize emin misiniz?", 
      icon: "warning",
      showCancelButton: true,
      confirmButtonText: "Evet",
      cancelButtonText: "Hayır"
          ...
          success: function(response) {
            ...
            if (obj.success == true) {
              Swal.fire(
                ...
                window.location.href = "adminPanel/news.php";
              });
            } else {
              var errors = obj.errors;
              Swal.fire(
