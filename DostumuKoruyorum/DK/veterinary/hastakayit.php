...
?>	
                ...
                <h1  style="text-align:left;    margin-left: -90px;">Kayıt Ekleme </h1> 
            </div>
							...
							<div class="card mb-5 mb-xl-10">
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									<div class="card-title m-0">
										<h3 class="fw-bolder m-0">Yeni Hasta Kayıt</h3>
									</div>
								</div>
										...
										<div class="card-body border-top p-9">
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="text" name="hayvanismi" id="hayvanadi" class="form-control form-control-lg form-control-solid" placeholder="Hasta Adı"/>
												</div>
											</div>											
											<div class="row mb-6">
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="text" name="rahatsizlik" id="rahatsizlik" class="form-control form-control-lg form-control-solid" placeholder="Rahatsızlığı Açıklayın"/>
												</div>
											</div>
											<div class="row mb-6">
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="text" name="fullname" id="fullname" class="form-control form-control-lg form-control-solid" placeholder="Ad Soyad"/>
												</div>
											</div>
											<div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="tel" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="(___) ___-__-__"/>
												</div>
											</div>
  ...
  $(document).on('click', '#sendHasta', function(e) {
    swal({
      ...
      if (result.value) {
        ...
        $.ajax({
          url: '/veterinary/hastakayit_Post.php',
          data: {
            myData: dataString
          },
          type: 'POST',
